...
export const EMAIL_CONTEUDO_SEED = [
  ...
  { nome: 'Encerramento mais satisfação', ativo: false, saudacao: '', corpo: '', gatilho: { criterios: [] } },
  { nome: 'Repescagem da satisfação', ativo: false, saudacao: '', corpo: '', gatilho: { criterios: [] } },
