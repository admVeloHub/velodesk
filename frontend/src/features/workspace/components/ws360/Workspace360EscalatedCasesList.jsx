...
import {
  ESCALATED_CASES_SUMMARY,
  getEscalatedCasesGroups,
} from '../../../../services/workspace/escalatedCasesData';
import Workspace360TicketRow from './Workspace360TicketRow';

export default function Workspace360EscalatedCasesList({ onBack, onOpenTicket }) {
  const groups = getEscalatedCasesGroups();
      ...
      <header className="ws360-escalated-list__head">
        ...
        <div className="ws360-escalated-list__title-wrap">
          ...
          <p className="ws360-escalated-list__subtitle">
            {total} tickets · {ESCALATED_CASES_SUMMARY.slaCriticalCount} com SLA crítico
          </p>
        </div>
      </header>
      ...
      {groups.map((group) => (
        <div key={group.id} className="ws360-escalated-list__group">
          <div className={'ws360-escalated-list__group-head ws360-escalated-list__group-head--' + group.accent}>
            ...
            <span className="ws360-escalated-list__group-count">{group.tickets.length} casos</span>
          </div>
