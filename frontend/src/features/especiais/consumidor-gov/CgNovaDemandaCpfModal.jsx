/**
 * CgNovaDemandaCpfModal — etapa CPF para nova demanda ConsumidorGov
 */
...
export default function CgNovaDemandaCpfModal({ open, onClose, onSuccess }) {
  const {
    cpfRef,
    cpfInput,
    loading,
    ...
    handleCpfChange,
    handleKeyDown,
  } = useGovNovaDemandaCpf({ onSuccess, onClose });
