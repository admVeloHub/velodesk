/**
 * ConsumidorGovToolbar — busca, ações e chips de filtro
 */
import React from 'react';
import { CG_FILTER_CHIPS } from '../../../services/especiais/consumidorGovData';

export default function ConsumidorGovToolbar({
  search,
  onSearchChange,
  activeChips,
  onToggleChip,
  ...
  return (
    <div className="ra-toolbar">
      <div className="ra-toolbar__row">
        ...
        <div className="ra-toolbar__actions">
          ...
          <button type="button" className="ra-toolbar__btn ra-toolbar__btn--primary" onClick={() => onAction?.('nova')}>
            <i className="ti ti-plus" aria-hidden="true" /> Nova demanda
          </button>
        </div>
      </div>
      ...
      <div className="ra-toolbar__filters">
        ...
        <span className="ra-toolbar__group-label">Agrupar por: Status ConsumidorGov</span>
      </div>
    </div>
  );
}
