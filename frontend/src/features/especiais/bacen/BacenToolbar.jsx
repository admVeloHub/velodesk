/**
 * BacenToolbar — busca, ações e chips de filtro
 */
import React from 'react';
import { BC_FILTER_CHIPS } from '../../../services/especiais/bacenData';

export default function BacenToolbar({
  search,
  onSearchChange,
  activeChips,
  onToggleChip,
  ...
  return (
    <div className="ra-toolbar">
      ...
      <div className="ra-toolbar__filters">
        ...
        <span className="ra-toolbar__group-label">Agrupar por: Status Bacen</span>
      </div>
    </div>
  );
}
