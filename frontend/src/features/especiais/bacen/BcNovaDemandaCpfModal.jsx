/**
 * BcNovaDemandaCpfModal — etapa CPF para nova demanda Bacen
 */
...
export default function BcNovaDemandaCpfModal({ open, onClose, onSuccess }) {
  const {
    cpfRef,
    cpfInput,
    loading,
    ...
    handleCpfChange,
    handleKeyDown,
  } = useBacenNovaDemandaCpf({ onSuccess, onClose });
