/**
 * BcNovaDemandaModal — cadastro manual de demanda Bacen
 */
import React, { useEffect } from 'react';
import { createPortal } from 'react-dom';

export default function BcNovaDemandaModal({ open, onClose, onManual }) {
  useEffect(() => {
          ...
          <div className="queue-box-modal__head-main">
            ...
            <div>
              ...
              <p className="queue-box-modal__subtitle">
                Cadastre manualmente uma demanda registrada no Bacen.
              </p>
            </div>
          </div>
          <button
