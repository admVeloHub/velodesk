/**
 * BacenRegistroPage — formulário de registro / resposta RA
 */
...
import {
  ...
  formatSlaRestante,
  getStatusLabel,
} from '../../../services/especiais/bacenData';
import {
  createEmptyDemanda,
  getDemandaById,
  saveDemandaDraft,
} from '../../../services/especiais/bacenStore';
import { registerDemandaAndCreateTicket } from '../../../services/especiais/bacenTicketService';
...
export default function BacenRegistroPage() {
  const { id } = useParams();
  ...
  if (!isNew && !initial) {
    return <Navigate to="/especiais/bacen" replace />;
  }
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      navigate(`/especiais/bacen/ticket/${id}`);
    } catch {
  ...
  const protocoloDisplay = form.protocoloBacen ? `#${form.protocoloBacen}` : '—';
  const slaRestante = formatSlaRestante(form.prazoLegal);

  return (
    <div className="ra-registro" id="bacenRegistro">
      <header className="ra-registro__header">
        <div className="ra-registro__header-left">
          ...
          <div className="ra-registro__header-meta">
            ...
            <span className={`ra-badge ra-badge--${form.statusBc}`}>
              {getStatusLabel(form.statusBc)}
            </span>
          </div>
        </div>
        ...
        <div className="ra-registro__layout">
          <main className="ra-registro__main">
            <section className="ra-registro__card">
              ...
              <div className="ra-registro__field">
                <label htmlFor="bc-assunto">Assunto</label>
                <input
                  id="bc-assunto"
                  type="text"
              ...
              <div className="ra-registro__field">
                <label htmlFor="bc-descricao">Descrição da demanda</label>
                <textarea
                  id="bc-descricao"
              ...
              <div className="ra-registro__row ra-registro__row--2">
                <div className="ra-registro__field">
                  <label htmlFor="bc-id-ext">ID da demanda</label>
                  <input
                    id="bc-id-ext"
                    type="text"
                ...
                <div className="ra-registro__field">
                  <label htmlFor="bc-data">Data da demanda</label>
                  <input
                    id="bc-data"
                    type="text"
                    className="ra-registro__input ra-registro__input--readonly"
            ...
            <section className="ra-registro__card">
              ...
              <div className="ra-registro__row ra-registro__row--3">
                <div className="ra-registro__field">
                  <label htmlFor="bc-produto">Produto</label>
                  <select
                    id="bc-produto"
                ...
                <div className="ra-registro__field">
                  <label htmlFor="bc-tipo">Tipo</label>
                  <select
                    id="bc-tipo"
                    className="ra-registro__select"
                    value={form.tipo}
            ...
            <section className="ra-registro__card">
              <div className="ra-registro__card-head">
                <h2 className="ra-registro__card-title">Resposta pública — Bacen</h2>
          ...
          <aside className="ra-registro__side">
            <section className="ra-registro__side-card">
              <h3 className="ra-registro__side-title">Órgão Bacen</h3>
              <div className="ra-registro__field">
                <label htmlFor="bc-orgao">Órgão</label>
                <select
                  id="bc-orgao"
                  className="ra-registro__select"
                  value={form.orgaoBacen || ''}
                  onChange={(e) => updateField('orgaoBacen', e.target.value)}
                >
                  <option value="">Selecione...</option>
                  {BC_ORGAOS.map((o) => (
              ...
              <div className="ra-registro__row ra-registro__row--2">
                <div className="ra-registro__field">
                  <label htmlFor="bc-cidade">Cidade</label>
                  <input
                    id="bc-cidade"
                    type="text"
            ...
            <section className="ra-registro__side-card ra-registro__side-card--whatsapp">
              ...
              <div className="ra-registro__field">
                <label htmlFor="bc-telefone">Telefone</label>
                <input
                  id="bc-telefone"
                  type="text"
                  className="ra-registro__input"
              ...
              <div className="ra-registro__field">
                <label htmlFor="bc-wa-msg">Mensagem</label>
                <textarea
                  id="bc-wa-msg"
            ...
            <section className="ra-registro__side-card">
              ...
              <div className="ra-registro__field">
                <label htmlFor="bc-consumidor">Nome</label>
                <input
                  id="bc-consumidor"
                  type="text"
              ...
              <div className="ra-registro__field">
                <label htmlFor="bc-cpf">CPF</label>
                <input
                  id="bc-cpf"
                  type="text"
                  className="ra-registro__input"
            ...
            <section className="ra-registro__side-card">
              <div className="ra-registro__field">
                <label htmlFor="bc-atendente">Atendente</label>
                <input
                  id="bc-atendente"
                  type="text"
                  className="ra-registro__input"
      ...
      <footer className="ra-registro__footer">
        <div className="ra-registro__footer-summary">
          ...
          <span>·</span>
          <span>{getStatusLabel(form.statusBc)}</span>
          <span>·</span>
