/**
 * BcQueuePanel — filas Bacen (layout CRM)
 */
...
export default function BcQueuePanel({
  activeGroup,
  searchQuery,
  collapsed,
  groupCounts,
      ...
      <div className="ra-crm-queue__inner">
        <div className="ra-crm-queue__header">
          <div className="ra-crm-queue__header-top">
            <h2 className="ra-crm-queue__title">Filas Bacen</h2>
            <button
              type="button"
        ...
        <div className="ra-crm-queue__footer">
          <button
            ...
            onClick={() => navigate('/especiais/bacen')}
          >
          ...
          <button
            ...
            onClick={() => (onNovaReclamacao ? onNovaReclamacao() : navigate('/especiais/bacen/nova'))}
          >
