/**
 * ProconToolbar — busca, ações e chips de filtro
 */
import React from 'react';
import { PC_FILTER_CHIPS } from '../../../services/especiais/proconData';

export default function ProconToolbar({
  search,
  onSearchChange,
  activeChips,
  onToggleChip,
  ...
  return (
    <div className="ra-toolbar">
      ...
      <div className="ra-toolbar__filters">
        ...
        <span className="ra-toolbar__group-label">Agrupar por: Status Procon</span>
      </div>
    </div>
  );
}
