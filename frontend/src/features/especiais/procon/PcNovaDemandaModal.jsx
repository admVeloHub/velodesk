/**
 * PcNovaDemandaModal — cadastro manual de demanda Procon
 */
import React, { useEffect } from 'react';
import { createPortal } from 'react-dom';

export default function PcNovaDemandaModal({ open, onClose, onManual }) {
  useEffect(() => {
          ...
          <div className="queue-box-modal__head-main">
            ...
            <div>
              ...
              <p className="queue-box-modal__subtitle">
                Cadastre manualmente uma demanda registrada no Procon.
              </p>
            </div>
          </div>
          <button
