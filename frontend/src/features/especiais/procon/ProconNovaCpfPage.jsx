/**
 * ProconNovaCpfPage — nova demanda Procon por CPF (rota /especiais/procon/nova)
 */
...
export default function ProconNovaCpfPage() {
  const navigate = useNavigate();

  const handleSuccess = (pcId) => {
  ...
  const {
    ...
    handleCpfChange,
    handleKeyDown,
  } = useProconNovaDemandaCpf({ onSuccess: handleSuccess, onClose: handleClose });

  return (
    <>
      <div className="ra-registro ra-nova-cpf-page" id="proconNovaCpf">
