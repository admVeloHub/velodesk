/**
 * useProconNovaDemandaCpf — lookup CPF + criação automática de demanda/ticket Procon
 */
import { useCallback, useEffect, useRef, useState } from 'react';
import { createDemandaFromCliente, createDemandaFromCpf } from '../services/especiais/proconTicketService';
import { isValidCpfDigits, maskCpfInput, normalizeCpf } from '../services/desk/utils';
import { useNotifications } from '../context/NotificationContext';

export function useProconNovaDemandaCpf({ onSuccess, onClose } = {}) {
