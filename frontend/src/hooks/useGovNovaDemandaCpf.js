/**
 * useGovNovaDemandaCpf — lookup CPF + criação automática de demanda/ticket ConsumidorGov
 */
import { useCallback, useEffect, useRef, useState } from 'react';
import { createDemandaFromCliente, createDemandaFromCpf } from '../services/especiais/consumidorGovTicketService';
import { isValidCpfDigits, maskCpfInput, normalizeCpf } from '../services/desk/utils';
import { useNotifications } from '../context/NotificationContext';

export function useGovNovaDemandaCpf({ onSuccess, onClose } = {}) {
